...
export const HeroSection = () => {
  // const { ref, isVisible } = useScrollAnimation(); // Removed in favor of individual components
      ...
      <div className="container px-0 md:px-0 lg:px-10 xl:px-28 mx-auto">
        <div className="grid lg:grid-cols-[50%_50%] gap-12 lg:gap-0 items-center">
          ...
          >
            ...
            <StaggerText
              tag="h1"
              className="text-4xl md:text-5xl lg:text-[60px] font-medium text-white leading-tight lg:leading-[72px] mb-6 lg:mb-4 tracking-tight max-w-xl"
              stagger={0.02}
            >
            ...
            <StaggerText
              tag="p"
              className="text-base md:text-lg lg:text-xl text-white/60 mb-8 lg:mb-10 max-w-xl leading-relaxed lg:leading-[32px] font-normal mx-auto lg:mx-0"
              stagger={0.01}
              delay={1.2}
            >
          ...
          {/* Right Image */}
          <FadeIn delay={0.2} direction="up" className="h-full flex items-center justify-center lg:justify-center">
