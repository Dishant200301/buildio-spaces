...
const About = () => {
  //   const { ref: heroRef, isVisible: heroVisible } = useScrollAnimation(); // Removed
  //   const { ref: storyRef, isVisible: storyVisible } = useScrollAnimation(); // Removed
  //   const { ref: missionRef, isVisible: missionVisible } = useScrollAnimation(); // Removed
  //   const { ref: resultsRef, isVisible: resultsVisible } = useScrollAnimation(); // Removed
      ...
      <main className="pt-28 md:pt-32 overflow-hidden">
        ...
        <section className="pt-6 pb-10 px-6">
          <div className="container mx-auto px-0 md:px-0 lg:px-10 xl:px-28 text-center">
            ...
            <StaggerText
              tag="h1"
              className="text-[28px] md:text-5xl lg:text-6xl font-semibold text-foreground mb-4 mx-auto leading-[1.1]"
              stagger={0.03}
            >
            ...
            <StaggerText
              tag="p"
              className="text-base md:text-[20px] text-white/70 max-w-2xl mx-auto mb-10 md:mb-16 leading-relaxed"
              stagger={0.01}
              delay={1.5}
            >
        ...
        <section className="py-12 md:py-20 px-6">
          <div className="container mx-auto px-0 md:px-0 lg:px-10 xl:px-28 text-center">
            ...
            <FadeIn delay={0.2} className="w-full">
              <div
                className="bg-[#1f1f1f] rounded-[24px] md:rounded-[40px] p-6 md:p-12 relative overflow-hidden min-h-[auto] md:min-h-[500px] flex flex-col items-center"
              >
          ...
          <div className="container mx-auto px-0 md:px-0 lg:px-10 xl:px-28">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              <FadeIn delay={0.3} className="h-full">
                <div
                  className="relative rounded-[24px] md:rounded-[40px] min-h-[200px] overflow-hidden aspect-square md:aspect-[16/10] lg:aspect-square bg-card"
                >
                  <img
        ...
        <section className="py-12 md:py-20 px-6">
          <div className="container mx-auto px-0 md:px-0 lg:px-10 xl:px-28">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              {/* Left Image */}
              <FadeIn delay={0.2} className="order-2 lg:order-none h-full">
                <div
                  className="relative rounded-[24px] md:rounded-[30px] min-h-[200px] overflow-hidden aspect-[4/5] md:aspect-[16/10] lg:aspect-square bg-card"
                >
                  <img
              ...
              <div className="order-1 lg:order-none">
                ...
                <FadeIn delay={0.1}>
                  <h2 className="text-2xl md:text-5xl font-semibold text-foreground mb-4 leading-tight">
