                ...
                <section className="py-12 md:py-12 px-6">
                    <div className="px-0 md:px-0 lg:px-10 xl:px-28 mx-auto container">
                        ...
                        >
                            <SectionHeader
                                badge="Insights"
                                title="Stories regarding architecture"
                                description="Explore the latest trends, technologies, and ideas shaping the built environment."
                        ...
                        <div
                            ref={ref}
                            className={cn(
                                "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 opacity-0",
